...
1. [Cookbook](/cookbook) chevron\_right- [Navigation](/cookbook/navigation) chevron\_right- [Return data from a screen](/cookbook/navigation/returning-data)
...
1. Define the home screen- Add a button that launches the selection screen- Show the selection screen with two buttons- When a button is tapped, close the selection screen- Show a snackbar on the home screen with the selection
...
* Launches the SelectionScreen when it's tapped.* Waits for the SelectionScreen to return a result.
...
```
 ...
 ![Returning data demo](/assets/images/docs/cookbook/returning-data.webp)
...
Thank you for your feedback!
 ...
 [feedback Provide details](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&&page-url=https://docs.flutter.dev/cookbook/navigation/returning-data/&page-source=https://github.com/flutter/website/tree/main/src/content/cookbook/navigation/returning-data.md)

Thank you for your feedback! Please let us know what we can do to improve.

 [bug\_report Provide details](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&&page-url=https://docs.flutter.dev/cookbook/navigation/returning-data/&page-source=https://github.com/flutter/website/tree/main/src/content/cookbook/navigation/returning-data.md)

Unless stated otherwise, the documentation on this site reflects the latest stable version of Flutter. Page last updated on 2025-08-19. [View source](https://github.com/flutter/website/tree/main/src/content/cookbook/navigation/returning-data.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&&page-url=https://docs.flutter.dev/cookbook/navigation/returning-data/&page-source=https://github.com/flutter/website/tree/main/src/content/cookbook/navigation/returning-data.md "Report an issue with this page").
