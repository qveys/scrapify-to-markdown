...
list On this page  chevron\_right Set up Flutter for your needs 

[vertical\_align\_top Set up Flutter for your needs](#document-title) 

* [Install and set up Flutter](#install)* [Set up an IDE or editor](#editor)* [Set up a target platform](#target-platform)* [Continue your Flutter journey](#next-steps)
...
1. [Get started](/get-started) chevron\_right- [Custom setup](/get-started/custom)
...
If you plan to use VS Code or another Code - OSS derived editor, consider following the [Flutter quick start](/get-started/quick) instead.
...
Use VS Code to quickly set up your Flutter development environment.](/install/with-vs-code)[Install manually For specific releases

Manually install and set up a specific Flutter SDK release.](/install/manual)
...
Set up Flutter support in VS Code.](/tools/vs-code#setup)[Android Studio

Set up Flutter support in Android Studio.](/tools/android-studio#setup)[IntelliJ

Set up Flutter support in an IntelliJ-based IDE.](/tools/android-studio#setup)[Firebase Studio

Create a new Flutter workspace in Firebase Studio.](https://studio.firebase.google.com/new/flutter)
...
We recommend [developing for the web](/platform-integration/web/setup) first as it requires no additional setup besides an appropriate browser. You can always set up development for additional target platforms later.
...
Set up your development environment to build Flutter apps for Windows desktop.](/platform-integration/windows/setup)[Target macOS On macOS only

Set up your development environment to build Flutter apps for macOS desktop.](/platform-integration/macos/setup)[Target Linux On Linux only

Set up your development environment to build Flutter apps for Linux desktop.](/platform-integration/linux/setup)
...
Follow the codelab on [Building your first app](/get-started/codelab), set up development for an [additional target platform](/platform-integration#setup), or explore some of these other learning resources.
...
Thank you for your feedback!
 ...
 [feedback Provide details](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&&page-url=https://docs.flutter.dev/get-started/custom/&page-source=https://github.com/flutter/website/tree/main/src/content/get-started/custom.md)

Thank you for your feedback! Please let us know what we can do to improve.

 [bug\_report Provide details](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&&page-url=https://docs.flutter.dev/get-started/custom/&page-source=https://github.com/flutter/website/tree/main/src/content/get-started/custom.md)

Unless stated otherwise, the documentation on this site reflects the latest stable version of Flutter. Page last updated on 2025-09-25. [View source](https://github.com/flutter/website/tree/main/src/content/get-started/custom.md) or [report an issue](https://github.com/flutter/website/issues/new?template=1_page_issue.yml&&page-url=https://docs.flutter.dev/get-started/custom/&page-source=https://github.com/flutter/website/tree/main/src/content/get-started/custom.md "Report an issue with this page").
